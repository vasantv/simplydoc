  ...
  function displayResult(resLatLng, pageNum) { 
		...
		$.post("getObGynNearBy.php", { lat: resLatLng.lat(), long: resLatLng.lng(), radius1: rad1, radius2: rad2, num: 10, offset: offPage}, 
			function(data){				
				if(data == 0) { 				
  ...
  {
	 $.post("getObGynResultCount.php", { lat: latlng.lat(), long: latlng.lng() }, 
			function(data){
